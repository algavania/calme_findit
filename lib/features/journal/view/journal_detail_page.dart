...
class _JournalDetailPageState extends State<JournalDetailPage> {
  ...
  @override
  void initState() {
    _controllers.addAll(List.generate(widget.questions.length, (index) {
      var answer = '';
            ...
            children: [
              ...
              Expanded(
                  child: GestureDetector(
                    ...
                    child: Container(
                        color: Colors.white, child: SingleChildScrollView(child: _buildAnswerWidget())),
                  )),
            ],
          ),
        ),
